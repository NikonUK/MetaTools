...
cls
title Meta Toolkit
echo               [7mMetaToolkit[0m			      Version: [7m%version%[0m
echo ==========================================
echo Which would you like to do?
echo ==========================================

:: Options
cmdMenuSel f870 "Change Recording Settings" "Mirror screen to PC" "Sideload an APK File" "Uninstall an App" "Keep Awake" "Enable Wired ALVR" "Change Refresh Rate" "Replay Tools" "Change Quest Resolution" "Update MetaToolkit" "ADB Options" "==========================================" "Developer Credits" "Special Thanks" "Help"
...
:dev1
cls
:: Redirects the user to my youtube channel
...
cmdMenuSel f870 "Nikon#6414" "==Back=="
...
pause
start https://github.com/NikonUK/MetaTools/releases/latest
exit
...
pause
start https://github.com/NikonUK/MetaTools/release/latest
exit
